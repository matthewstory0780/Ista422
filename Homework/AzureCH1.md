Homework, ISTA-422
--
Chapter 01, Fundamentals of Azure, 2nd Edition
--
...
9. Access the Azure Resource Manager samples on Github. Search for a quickstart template that will allow you to set up a free SQL Database for a web application. This template has four ﬁles. One ﬁle is a markdown ﬁle. What is the type of the other three ﬁles9. 
